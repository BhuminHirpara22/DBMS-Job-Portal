      ...
      <div className="flex flex-col md:flex-row justify-center items-center p-10 md:p-20 gap-10">
        <div className="text-center md:text-left">
          ...
          <p className="mt-4 text-gray-400">
            Connect with thousands of employers and opportunities tailored to
            your skills and ambitions.
          </p>
        </div>
        <div
          className="bg-gray-900 p-6 rounded-lg w-full md:w-2/5 cursor-pointer"
        ...
        >
          ...
          <button className="mt-6 w-full bg-blue-500 text-white py-2 rounded-md flex items-center justify-center hover:bg-blue-600">
